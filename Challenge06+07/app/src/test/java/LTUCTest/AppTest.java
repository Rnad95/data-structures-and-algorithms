...
//        App classUnderTest = new App();
    ...
    @Test void kNegative(){
        ...
        list.insert(5);
        list.insert(6);
        int num=list.kthFromEnd(-2);
        assertEquals(-1,num);
    }
    @Test void ListOneElement(){
        linkedList<Integer> list = new linkedList<>();
        list.insert(3);
        int num=list.kthFromEnd(0);
        assertEquals(3,num);
    }
    @Test void kElementInMiddle(){
        linkedList<Integer> list = new linkedList<>();
        list.insert(1);
        list.insert(2);
        list.insert(3);
